  ...
  <section className="relative h-[600px]">
    ...
    <div className="absolute inset-0 bg-black/40 flex items-center justify-center px-6">
      <div className="text-center text-white max-w-4xl">
        <h2 className="text-5xl lg:text-7xl font-light tracking-wide mb-8 scroll-reveal" style={{ animationDelay: '0.1s' }}>
          The Art of Bespoke
        </h2>
        <p className="text-lg leading-relaxed mb-10 tracking-wide scroll-reveal" style={{ animationDelay: '0.2s' }}>
