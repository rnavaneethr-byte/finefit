  ...
  <section className="container mx-auto px-6 lg:px-12 py-24">
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
      ...
      <div className="space-y-6">
        <p className="text-xs tracking-[0.3em] text-neutral-500">OUR LOCATIONS</p>
        <h2 className="text-5xl font-light tracking-wide">BAHRAIN</h2>
        <h3 className="text-3xl font-light italic tracking-wide">Bespoke Tailoring</h3>
