    ...
    <div className="font-serif text-neutral-800 bg-white">
      ...
      <section className="relative h-[60vh]">
        ...
        <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-white px-6">
          <p className="text-xs tracking-[0.3em] mb-4">SINCE 1970</p>
          <h1 className="text-6xl lg:text-8xl font-light tracking-[0.2em] text-center mb-4">
            HERITAGE
          </h1>
          <p className="text-xl lg:text-2xl font-light italic tracking-wide">
      ...
      <section className="bg-neutral-900 text-white py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          <div className="text-center mb-20">
            <p className="text-xs tracking-[0.3em] text-neutral-400 mb-4">OUR JOURNEY</p>
          ...
          <div className="relative max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-4">
              ...
              <div className="text-center group">
                ...
                <h3 className="text-3xl font-light mb-4 text-neutral-400 group-hover:text-white transition-colors">1970</h3>
                <h4 className="text-lg tracking-wide mb-3 font-light">The Beginning</h4>
              ...
              <div className="text-center group">
                ...
                <h3 className="text-3xl font-light mb-4 text-neutral-400 group-hover:text-white transition-colors">1980s</h3>
                <h4 className="text-lg tracking-wide mb-3 font-light">Mastery</h4>
                <p className="text-sm text-neutral-400 leading-relaxed">
              ...
              <div className="text-center group">
                ...
                <h3 className="text-3xl font-light mb-4 text-neutral-400 group-hover:text-white transition-colors">1990s</h3>
                <h4 className="text-lg tracking-wide mb-3 font-light">Tradition</h4>
                <p className="text-sm text-neutral-400 leading-relaxed">
              ...
              <div className="text-center group">
                ...
                <h3 className="text-3xl font-light mb-4 text-neutral-400 group-hover:text-white transition-colors">2008</h3>
                <h4 className="text-lg tracking-wide mb-3 font-light">Finfit Born</h4>
                <p className="text-sm text-neutral-400 leading-relaxed">
              ...
              <div className="text-center group">
                ...
                <h3 className="text-3xl font-light mb-4 text-white">2026</h3>
                <h4 className="text-lg tracking-wide mb-3 font-light">Today</h4>
                <p className="text-sm text-neutral-400 leading-relaxed">
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 max-w-5xl mx-auto">
            <div className="text-center">
              <div className="text-6xl font-light text-neutral-800 mb-2">46</div>
              <p className="text-sm tracking-wider text-neutral-600">YEARS EXPERTISE</p>
            </div>
            <div className="text-center">
              <div className="text-6xl font-light text-neutral-800 mb-2">16</div>
              <p className="text-sm tracking-wider text-neutral-600">YEARS IN BAHRAIN</p>
            </div>
            <div className="text-center">
              <div className="text-6xl font-light text-neutral-800 mb-2">∞</div>
              <p className="text-sm tracking-wider text-neutral-600">DEDICATION</p>
            </div>
            <div className="text-center">
              <div className="text-6xl font-light text-neutral-800 mb-2">1</div>
              <p className="text-sm tracking-wider text-neutral-600">MASTER TAILOR</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-6 lg:px-12 py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6">
            <p className="text-xs tracking-[0.3em] text-neutral-500">OUR FOUNDER</p>
      ...
      <section className="bg-white py-24">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="text-center mb-16">
            <p className="text-xs tracking-[0.3em] text-neutral-500 mb-4">OUR BELIEFS</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-neutral-50 p-8 group hover:bg-neutral-900 transition-all duration-500 cursor-pointer">
              ...
              <h3 className="text-2xl font-light tracking-wide mb-4 group-hover:text-white transition-colors">Traditional Craftsmanship</h3>
              <p className="text-sm leading-relaxed text-neutral-600 group-hover:text-neutral-300 transition-colors">
            ...
            <div className="bg-neutral-50 p-8 group hover:bg-neutral-900 transition-all duration-500 cursor-pointer">
              ...
              <h3 className="text-2xl font-light tracking-wide mb-4 group-hover:text-white transition-colors">Personal Service</h3>
              <p className="text-sm leading-relaxed text-neutral-600 group-hover:text-neutral-300 transition-colors">
            ...
            <div className="bg-neutral-50 p-8 group hover:bg-neutral-900 transition-all duration-500 cursor-pointer">
              ...
              <h3 className="text-2xl font-light tracking-wide mb-4 group-hover:text-white transition-colors">Finest Materials</h3>
              <p className="text-sm leading-relaxed text-neutral-600 group-hover:text-neutral-300 transition-colors">
            ...
            <div className="bg-neutral-50 p-8 group hover:bg-neutral-900 transition-all duration-500 cursor-pointer">
              ...
              <h3 className="text-2xl font-light tracking-wide mb-4 group-hover:text-white transition-colors">Timeless Elegance</h3>
              <p className="text-sm leading-relaxed text-neutral-600 group-hover:text-neutral-300 transition-colors">
            ...
            <div className="bg-neutral-50 p-8 group hover:bg-neutral-900 transition-all duration-500 cursor-pointer">
              ...
              <h3 className="text-2xl font-light tracking-wide mb-4 group-hover:text-white transition-colors">Uncompromising Quality</h3>
              <p className="text-sm leading-relaxed text-neutral-600 group-hover:text-neutral-300 transition-colors">
            ...
            <div className="bg-neutral-900 p-8 text-white">
              ...
              <h3 className="text-2xl font-light tracking-wide mb-4">Our Promise</h3>
      ...
      <section className="bg-neutral-100 py-24">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                <p className="text-xs tracking-[0.3em] text-neutral-500 mb-4">OUR CLIENTS</p>
                <h2 className="text-5xl font-light tracking-wide mb-8">
              ...
              <div className="bg-white p-12 shadow-lg">
                ...
                <blockquote className="text-xl font-light italic text-neutral-800 mb-6 leading-relaxed">
                ...
                <div className="text-sm tracking-wider text-neutral-500">
                  — FINFIT PROMISE
                </div>
              </div>
            </div>
